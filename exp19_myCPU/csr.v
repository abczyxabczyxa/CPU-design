...
module CSR (
    ...
    //below are related to addr trans
    ...
    begin
        ...
        else if(csr_inst_tlb_refill | csr_data_tlb_refill)         //触发TLB重填例外
        begin
            csr_crmd_da <= 1'b1;
        end
        else if(wb_ertn_flush && csr_estat_ecode == 6'h3f)
        begin
            csr_crmd_da <= 1'b0;
        end
        else if(csr_we && csr_num == `CSR_CRMD)
    ...
    begin
        ...
        else if (csr_inst_tlb_refill | csr_data_tlb_refill)
        begin
            csr_crmd_pg <= 1'b0;
        end
        else if (wb_ertn_flush && csr_estat_ecode == 6'h3f)
    ...
    begin
        ...
        begin
        csr_badv_vaddr <= csr_wmask[`CSR_BADV_VADDR] &csr_wvalue[`CSR_BADV_VADDR] |~csr_wmask[`CSR_ECFG_LIE] & 13'h1bff &csr_ecfg_lie;
        end
        else if(wb_ex && (wb_inst_tlb_ex != 2'b0))
        begin
        csr_badv_vaddr <= wb_pc;
        end
        else if(wb_ex && wb_data_tlb_ex != 3'b0)
        begin
        csr_badv_vaddr <= wb_data_addr;
        end
    end
...
// waiting for revise
    ...
    begin
        ...
        begin
            csr_tlbehi <= wb_pc[31:13];
        end
        else if(wb_ex && wb_data_tlb_ex != 3'b0)
        begin
            csr_tlbehi <= wb_data_addr[31:13];
        end
...
// waiting for revise
    ...
    begin
        ...
        begin
            csr_dmw0_plv0 <=csr_wmask[`CSR_DMW0_PLV0] & csr_wvalue[`CSR_DMW0_PLV0] | ~csr_wmask[`CSR_DMW0_PLV0] &csr_dmw0_plv0;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw0_plv3 <=csr_wmask[`CSR_DMW0_PLV3] & csr_wvalue[`CSR_DMW0_PLV3] | ~csr_wmask[`CSR_DMW0_PLV3] &csr_dmw0_plv3;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw0_mat <=csr_wmask[`CSR_DMW0_MAT] & csr_wvalue[`CSR_DMW0_MAT] | ~csr_wmask[`CSR_DMW0_MAT] &csr_dmw0_mat;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw0_pseg <=csr_wmask[`CSR_DMW0_PSEG] & csr_wvalue[`CSR_DMW0_PSEG] | ~csr_wmask[`CSR_DMW0_PSEG] &csr_dmw0_pseg;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw0_vseg <=csr_wmask[`CSR_DMW0_VSEG] & csr_wvalue[`CSR_DMW0_VSEG] | ~csr_wmask[`CSR_DMW0_VSEG] &csr_dmw0_vseg;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw1_plv0 <=csr_wmask[`CSR_DMW1_PLV0] & csr_wvalue[`CSR_DMW1_PLV0] | ~csr_wmask[`CSR_DMW1_PLV0] &csr_dmw1_plv0;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw1_plv3 <=csr_wmask[`CSR_DMW1_PLV3] & csr_wvalue[`CSR_DMW1_PLV3] | ~csr_wmask[`CSR_DMW1_PLV3] &csr_dmw1_plv3;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw1_mat <=csr_wmask[`CSR_DMW1_MAT] & csr_wvalue[`CSR_DMW1_MAT] | ~csr_wmask[`CSR_DMW1_MAT] &csr_dmw1_mat;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw1_pseg <=csr_wmask[`CSR_DMW1_PSEG] & csr_wvalue[`CSR_DMW1_PSEG] | ~csr_wmask[`CSR_DMW1_PSEG] &csr_dmw1_pseg;
        end
    end
    ...
    begin
        ...
        begin
            csr_dmw1_vseg <=csr_wmask[`CSR_DMW1_VSEG] & csr_wvalue[`CSR_DMW1_VSEG] | ~csr_wmask[`CSR_DMW1_VSEG] &csr_dmw1_vseg;
        end
    end
